...
function SidebarLink({ text, Icon, link }) {
    if (text === "logo") {
        return (
            <li
                className="flex gap-3 items-center w-fit px-4 py-1 hover:bg-[#181818] hover:cursor-pointer hover:rounded-full">
                <div className="logo w-8 m-auto hover:bg-[#181818] hover:cursor-pointer pt-3">
